class config:
    ...
    APP_ID = "input your app id"
    API_HASH = "input your app hash "
    DATABASE_URL = "input your database url"
    SUDO_USERS = "input your user id" # Sepearted by space.
    DOWNLOAD_DIRECTORY = "./downloads/"
    G_DRIVE_CLIENT_ID = "input your google client id"
    G_DRIVE_CLIENT_SECRET = "input your client secret"
